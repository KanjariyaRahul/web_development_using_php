    ...
    <section id="sidebar">
        <a href="#" class="brand"><img src="./img/logo.png" alt="" class="img"> </a>
         <ul class="side-menu top">
            ...
            <li>
                <a href="https://sites.google.com/view/rahulworks/home">
            ...
            <li>
                <a href="https://github.com/KanjariyaRahul">
    ...
    <section id="content">
        ...
        <nav id="navbar" >
           <div class="navbar-item"> 
            ...
            <div class="profile">
                <img src="./img/profile.bmp">
            </div>
            <div class="form-group">
                    <h4 class="title">Rahul Kanjariya</h4>
                </div>
        ...
        <div class="container">
            ...
            <div class="dashboard-item">
                ...
                <div class="btn-group">
                    <a href="https://github.com/KanjariyaRahul/web_development_using_php/tree/main/Task_1"><button class="btn btn-1">Task 1</button></a>
                    <a href="https://github.com/KanjariyaRahul/web_development_using_php/tree/main/Task_2"><button class="btn btn-2">Task 2</button></a>
                    <a href="https://github.com/KanjariyaRahul/web_development_using_php/tree/main/Task_3"><button class="btn btn-3">Task 3</button></a>
        ...
        <div id="footer">
            ...
            <div style="margin: 5px; text-align: start;">
                <p>Developed with love by © 2023 Rahul kanjariya</p>
            </div>
        </div>
